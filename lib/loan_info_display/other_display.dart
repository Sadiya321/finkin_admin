...
class OtherDisplay extends StatefulWidget {
  final String documentId;

  const OtherDisplay({Key? key, required this.documentId}) : super(key: key);

  @override
  State<OtherDisplay> createState() => _OtherDisplayState();
}

class _OtherDisplayState extends State<OtherDisplay> {
  static final GlobalKey<_OtherDisplayState> globalKey =
      GlobalKey<_OtherDisplayState>();
